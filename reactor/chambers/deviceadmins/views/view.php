 ...
 * @since       Version 1.0.0
 * @module      Deviceadmins
 * @filesource  Deviceadmins.views.view
 */
...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <?php endif; ?>
            <h4 class="page-title"><?=$ictdata['idioms']['da_module_title'];?></h4>
        </div>
    </div>
</div>
<div class="row">
    ...
    <div class="panel panel-border panel-primary">
        ...
        <script type="text/javascript">
            ...
            <table class="table table-striped table-bordered table-hover table-full-width" id="datatableajax" data-table-path="<?=$this->rview->url($ctrl_name.'/ajax_list');?>">
                <thead>
                    <tr>
                        <th><?=$ictdata['idioms']['da_c1'];?></th>
                        <th><?=$ictdata['idioms']['da_c2'];?></th>
                        <th><?=$ictdata['idioms']['da_c3'];?></th>
