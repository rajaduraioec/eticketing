 ...
 * @since       Version 1.0.0
 * @module      Deviceadmins
 * @filesource  Deviceadmins.views.edit
 */
...
<div class="modal-block modal-block-md modal-ajaxcontent-block">
    <div class="panel panel-color panel-info">
        <div class="panel-heading">
            ...
            <h3 class="panel-title"><?=$ictdata['idioms']['da_edit_title'];?></h3>
        </div>
                ...
                <div class="col-md-12">
                    <form id="modal-form" class="form-horizontal  mb-lg">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="" name="depot-name" placeholder="<?=$ictdata['idioms']['depots_f1p'];?>" value="<?=$info->depot_name;?>" maxlength="25" pattern="[a-zA-Z0-9/s]+" title="Only 25 Character alphanumeric allowed" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="field-2"><?=$ictdata['idioms']['da_f2'];?></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="adminid" name="admin-id" placeholder="<?=$ictdata['idioms']['da_f2p'];?>" value="<?=$info->admin_id;?>" maxlength="25" pattern="[a-zA-Z0-9]+" title="Only 25 Character alphanumeric allowed" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="adminname" name="admin-name" placeholder="<?=$ictdata['idioms']['da_f3p'];?>" value="<?=$info->admin_name;?>" maxlength="25" pattern="[a-zA-Z0-9/s]+" title="Only 25 Character alphanumeric allowed" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="field-4"><?=$ictdata['idioms']['da_f4'];?></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="adminpass" name="admin-pass" placeholder="<?=$ictdata['idioms']['da_f4p'];?>" value="<?=$info->admin_pass;?>" maxlength="10" pattern="[a-zA-Z0-9]+" title="Only 10 Character alphanumeric allowed" required>
                            </div>
                        </div>
                        <div class="form-group">
