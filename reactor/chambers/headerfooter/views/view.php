 ...
 * @since       Version 1.0.0
 * @module      Headerfooter
 * @filesource  Headerfooter.views.view
 */
...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <?php endif; ?>
            <h4 class="page-title"><?=$ictdata['idioms']['hfs_module_title'];?></h4>
        </div>
    </div>
</div>
<div class="row">
            ...
            <div class="row">
                ...
                <script type="text/javascript">
                    ...
                    <table class="table table-striped table-bordered table-hover table-full-width" id="datatableajax" data-table-path="<?=$this->rview->url($ctrl_name.'/ajax_list');?>">
                        <thead>
                            <tr>
                                <th><?=$ictdata['idioms']['hfs_c1'];?></th>
                                <th><?=$ictdata['idioms']['hfs_c2'];?></th>
                                <th><?=$ictdata['idioms']['hfs_c3'];?></th>
                                <th><?=$ictdata['idioms']['hfs_c4'];?></th>
