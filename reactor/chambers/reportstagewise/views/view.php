 ...
 * @filesource  Reportstagewise.views.view
 */
...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title"><?=$ictdata['idioms']['stage_report_title'];?></h4>
        </div>
    </div>
</div>
<div class="row">
            ...
            <table class="table table-striped table-bordered table-hover table-full-width" id="datatable" data-table-path="<?=$this->rview->url($ctrl_name.'/ajax_list');?>">
                <thead>
                    <tr>
                        ...
                        <th><?=$ictdata['idioms']['report_c53'];?></th>
...
<script type="text/javascript">
    var baseurl='<?=$this->rview->url('reportstagewise');?>';
    </script>
