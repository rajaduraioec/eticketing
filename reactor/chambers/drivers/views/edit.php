...
<div class="modal-block modal-block-md modal-ajaxcontent-block">
    <div class="panel panel-color panel-info">
        <div class="panel-heading">
            ...
            <h3 class="panel-title"><?=$ictdata['idioms']['drivers_edit_title'];?></h3>
        </div>
                ...
                <div class="col-md-12">
                    <form id="modal-form" class="form-horizontal  mb-lg">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="driverid" name="driver-id" placeholder="<?=$ictdata['idioms']['drivers_f1p'];?>" value="<?=$info->driver_id;?>" maxlength="25" pattern="[a-zA-Z0-9]+" title="Only 20 Character alphanumeric allowed">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="drivername" name="driver-name" placeholder="<?=$ictdata['idioms']['drivers_f2p'];?>"  value="<?=$info->driver_name;?>" required maxlength="25" pattern="[a-zA-Z0-9/s ]+" title="Only 25 Character alphanumeric allowed" required>
                            </div>
                        </div>
                        <div class="form-group">
