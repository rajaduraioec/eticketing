 ...
 * @filesource  Reportexpensewise.views.view
 */
...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title"><?=$ictdata['idioms']['exp_report_title'];?></h4>
        </div>
    </div>
</div>
<div class="row">
    ...
    <div class="panel panel-border panel-primary">
        ...
        <div class="col-md-12" id="reportdata">
            <table class="table table-striped table-bordered table-hover table-full-width" id="datatable" data-table-path="<?php echo base_url($ctrl_name.'/ajax_list');?>">
                <thead>
                    <tr>
...
<script type="text/javascript">
    var baseurl='<?=$this->rview->url('reportexpensewise');?>';
    </script>
