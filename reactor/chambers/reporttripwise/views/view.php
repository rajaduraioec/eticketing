 ...
 * @filesource  Reporttripwise.views.view
 */
        ...
        <div class="page-title-box">
            <div class="btn-group pull-right">
                <form class="form-inline" accept-charset="utf-8">
                    ...
                    <button type="button" onclick="report();" class="btn btn-info btn-single " id="rangebtn">Subm<?=$ictdata['idioms']['submitbtn'];?></button>
                </form>
            </div>
            <h4 class="page-title"><?=$ictdata['idioms']['trip_report_title'];?></h4>
        </div>
    </div>
</div>
<div class="row">
...
<script type="text/javascript">
    var baseurl='<?=$this->rview->url('reporttripwise');?>';
    </script>
