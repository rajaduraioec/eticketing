...
<div class="modal-block modal-block-md modal-ajaxcontent-block">
    <div class="panel panel-color panel-info">
        <div class="panel-heading">
            ...
            <h3 class="panel-title"><?=$ictdata['idioms']['depots_add_title'];?></h3>
        </div>
                ...
                <div class="col-md-12">
                    <form id="modal-form" class="form-horizontal  mb-lg">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="depotname" name="depot-name" placeholder="<?=$ictdata['idioms']['depots_f1p'];?>" required maxlength="25" pattern="[a-zA-Z0-9\s]+" title="Only 25 Character alphanumeric and space allowed">
