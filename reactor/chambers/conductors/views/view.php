 ...
 * @since       Version 1.0.0
 * @module      Conductors
 * @filesource  Conductors.views.view
 */
...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <?php endif; ?>
            <h4 class="page-title"><?=$ictdata['idioms']['conductors_module_title'];?></h4>
        </div>
    </div>
</div>
<div class="row">
    ...
    <div class="panel panel-border panel-primary">
        ...
        <script type="text/javascript">
            ...
            <table class="table table-striped table-bordered table-hover table-full-width" id="datatableajax" data-table-path="<?=$this->rview->url($ctrl_name.'/ajax_list');?>">
                <thead>
                    <tr>
                        <th><?=$ictdata['idioms']['conductors_c1'];?></th>
                        <th><?=$ictdata['idioms']['conductors_c2'];?></th>
