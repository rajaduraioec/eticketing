...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title"><?=$ictdata['idioms']['users_module_title'];?></h4>
        </div>
    </div>
</div>
<div class="row">
    ...
    <div class="panel panel-border panel-primary">
        ...
        <script type="text/javascript">
            ...
            <table class="table table-striped table-bordered table-hover table-full-width" id="datatableajax" data-table-path="<?=$this->rview->url($ctrl_name.'/ajax_list');?>">
                <thead>
                    <tr>
                        <th><?=$ictdata['idioms']['users_c1'];?></th>
                        <th><?=$ictdata['idioms']['users_c2'];?></th>
                        <th><?=$ictdata['idioms']['users_c3'];?></th>
                        <th><?=$ictdata['idioms']['users_c4'];?></th>
