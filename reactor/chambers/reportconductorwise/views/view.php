 ...
 * @filesource  Reportconductorwise.views.view
 */
        ...
        <div class="page-title-box">
            <div class="btn-group pull-right">
                <form class="form-inline" accept-charset="utf-8">
                    ...
                    ?>
                    <div class="form-group">
                        <select class="form-control select2" required id="conductor" >
                        <option value='all'>All Conductor's</option>
                            <?php
                            foreach($conductors as $conductor)
                                echo '<option value="'.$conductor['id_conductors'].'">'.$conductor['conductor_name'].'</option>';
                            ?>
                        </select>
                    </div>
                            <div class="form-group">
                    <input type="text" id="reportrange" class="form-control"/></div>
                    <button type="button" onclick="genconductorwisereport();" class="btn btn-info btn-single " id="rangebtn"><?=$ictdata['idioms']['submitbtn'];?></button>
                </form>
            </div>
            <h4 class="page-title"><?=$ictdata['idioms']['conductor_report_title'];?></h4>
        </div>
    </div>
</div>
<div class="row">
...
<script type="text/javascript">
    var baseurl='<?=$this->rview->url('reportconductorwise');?>';
    </script>
