 ...
 * @filesource  Passengeranalysis.controllers
 */

class Passengeranalysis extends BE_Controller {

    function __construct() {
        parent::__construct();
        $this->load->model('Passengeranalysis_model');
        $this->ctrl_name="passengeranalysis";
        $this->module_name="passenger-analysis";
    }
    public function index() {   
        if($this->rauth->has_access($this->module_name))
        {
            ...
            if($this->rauth->is_depot()):
                ...
                $data['depot']=NULL;
                $data['depots']=$this->Passengeranalysis_model->_getdepots();
            endif;
    ...
    public function ajax_response(){
        ...
        $data['depot']      = $depot;
        $date=explode('-', $range);
        $data['results']      = $this->Passengeranalysis_model->_getdata($date,$depot);
