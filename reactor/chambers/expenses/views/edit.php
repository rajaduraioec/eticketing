 ...
 * @since       Version 1.0.0
 * @module      Expenses
 * @filesource  Expenses.views.edit
 */
...
<div class="modal-block modal-block-md modal-ajaxcontent-block">
    <div class="panel panel-color panel-info">
        <div class="panel-heading">
            ...
            <h3 class="panel-title"><?=$ictdata['idioms']['expenses_edit_title'];?></h3>
        </div>
                ...
                <div class="col-md-12">
                    <form id="modal-form" class="form-horizontal  mb-lg">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="expensename" name="expense-name" value="<?=$info->expense_name;?>" maxlength="20" pattern="[a-zA-Z0-9\s]+" title="Only 20 Character alphanumeric and space allowed" disabled>
                                <span id="availability"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="field-2"><?=$ictdata['idioms']['status'];?></label>
                            <div class="col-sm-10">
                                <?php
                                if($info->active==1)
